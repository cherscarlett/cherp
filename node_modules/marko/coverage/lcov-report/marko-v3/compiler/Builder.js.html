...
<html lang="en">
<head>
    <title>Code coverage report for marko-v3/compiler/Builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">marko-v3/compiler/</a> Builder.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.98% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>249/293</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">64.63% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>53/82</span>
      </div>
      <div class='fl pad1y space-right2'>
...
592
593
594</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">11211×</span>
<span class="cline-any cline-yes">2271×</span>
<span class="cline-any cline-yes">8940×</span>
<span class="cline-any cline-yes">8939×</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7047×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7047×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1986×</span>
<span class="cline-any cline-yes">1986×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1986×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1768×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1768×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1768×</span>
<span class="cline-any cline-yes">1757×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1768×</span>
...
function makeNode(arg) {
    if (typeof arg === 'string') {
        ...
        return arg;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (arg == null) {
        return undefined;
    } else {
...
class Builder {
    arrayExpression(elements) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (elements) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(elements)) {
...
&nbsp;
    identifierOut<span class="fstat-no" title="function not covered" >(name) {</span>
<span class="cstat-no" title="statement not covered" >        return identifierOut;</span>
    }
&nbsp;
...
&nbsp;
    objectExpression(properties) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (properties) {
...
&nbsp;
    variableDeclarator<span class="fstat-no" title="function not covered" >(id, init) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof id === 'string') {</span>
<span class="cstat-no" title="statement not covered" >            id = new Identifier({name: id});</span>
        }
<span class="cstat-no" title="statement not covered" >        if (init) {</span>
<span class="cstat-no" title="statement not covered" >            init = makeNode(init);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return new VariableDeclarator({id, init});</span>
    }
&nbsp;
    var(id, init, kind) {
        if (!kind) {
...
<span class="cstat-no" title="statement not covered" >                        declarations[i] = new VariableDeclarator({</span>
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (!(declaration instanceof VariableDeclarator)) {
