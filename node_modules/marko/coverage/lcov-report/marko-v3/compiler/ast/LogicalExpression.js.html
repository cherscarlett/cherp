...
<html lang="en">
<head>
    <title>Code coverage report for marko-v3/compiler/ast/LogicalExpression.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v3/compiler/ast/</a> LogicalExpression.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    var result = '';
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (wrap) {
        result += '(';
    }
&nbsp;
    result += node;
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Invalid LogicalExpression: ' + this);</span>
        }
&nbsp;
...
&nbsp;
module.exports = LogicalExpression;</pre></td></tr>
</table></pre>
