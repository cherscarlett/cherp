...
<html lang="en">
<head>
    <title>Code coverage report for marko-v3/compiler/ast/Text.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v3/compiler/ast/</a> Text.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    appendText(text) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isLiteral()) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Text cannot be appended to a non-literal Text node');</span>
        }
&nbsp;
