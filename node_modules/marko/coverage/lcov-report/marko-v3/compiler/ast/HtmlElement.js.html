...
<html lang="en">
<head>
    <title>Code coverage report for marko-v3/compiler/ast/HtmlElement.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v3/compiler/ast/</a> HtmlElement.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.37% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>111/114</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4470×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (attributes) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (selfClosed) {
...
class HtmlElement extends Node {
    constructor(def) {
        ...
        this.argument = def.argument;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!(this._attributes instanceof HtmlAttributeCollection)) {
...
&nbsp;
        if (hasBody || bodyOnlyIf) {
            openTagOnly = false;
            selfClosed = false;
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (selfClosed){
<span class="cstat-no" title="statement not covered" >            openTagOnly = true;</span>
        }
&nbsp;
...
&nbsp;
    addDynamicAttributes(expression) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.dynamicAttributes) {
...
&nbsp;
    replaceAttributes<span class="fstat-no" title="function not covered" >(newAttributes) {</span>
<span class="cstat-no" title="statement not covered" >        this._attributes.replaceAttributes(newAttributes);</span>
    }
&nbsp;
    removeAttribute(name) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this._attributes) {
...
&nbsp;
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof tagName === 'string') {
...
&nbsp;
module.exports = HtmlElement;</pre></td></tr>
</table></pre>
